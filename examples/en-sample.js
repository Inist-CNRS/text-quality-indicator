...
console.log('===============================')
tqi.analyze("This is a long sentence but all words seem to be okay").then(function(result){
...
tqi.analyze("Color, abridgement and cheque are Canadian words").then(function(result){
...
tqi.analyze("Une phrase en français avec une mauvaise manière de découper").then(function(result){
...
tqiFr.analyze("Une phrase en français avec une bonne manière de découper").then(function(result){
